    ...
    <article className="pb-20">
      ...
      <div className="bg-card py-12 md:py-20 mb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-balance">{project.title}</h1>
            <div className="flex flex-wrap gap-8 text-sm text-muted-foreground">
              <div>
                <span className="block font-semibold text-foreground mb-1">Client</span>
                {project.client}
              </div>
              <div>
              ...
              <div>
                <span className="block font-semibold text-foreground mb-1">Category</span>
                {project.category}
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="max-w-3xl mb-20">
          <h2 className="text-2xl md:text-3xl font-serif font-bold mb-6">Overview</h2>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <div>
            <h2 className="text-2xl md:text-3xl font-serif font-bold mb-6">Role</h2>
            <p className="text-lg text-muted-foreground">{project.role}</p>
          </div>
          <div>
            <h2 className="text-2xl md:text-3xl font-serif font-bold mb-6">Services</h2>
        ...
        {/* Process */}
        <section className="max-w-3xl mb-20">
          <h2 className="text-2xl md:text-3xl font-serif font-bold mb-8">Process</h2>
          <div className="space-y-8">
            {project.process.map((step, i) => (
              <div key={i} className="border-l-2 border-primary pl-6">
                <h3 className="text-xl font-serif font-semibold mb-2">{step.phase}</h3>
        ...
        {/* Outcome */}
        <section className="max-w-3xl mb-20">
          <h2 className="text-2xl md:text-3xl font-serif font-bold mb-6">Outcome</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {project.outcome.metrics.map((metric, i) => (
              <div key={i} className="bg-card p-6 rounded-sm">
                <div className="text-3xl font-serif font-bold text-primary mb-2">{metric.value}</div>
        ...
        <section className="bg-card p-12 rounded-sm text-center">
          <h2 className="text-2xl md:text-3xl font-serif font-bold mb-4">Interested in working together?</h2>
